...
#define TRICK_FREEZE 3
	...
	int (*fe_diseqc_send_burst)(struct dvb_frontend* fe, enum fe_sec_mini_cmd minicmd);
	int (*fe_set_tone)(struct dvb_frontend* fe, enum fe_sec_tone_mode tone);
	int (*fe_set_voltage)(struct dvb_frontend* fe, enum fe_sec_voltage voltage);
