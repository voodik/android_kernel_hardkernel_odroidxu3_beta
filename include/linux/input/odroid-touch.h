...
//
//[*]--------------------------------------------------------------------------------------------------[*]
#ifndef __ODROID_TOUCH_H__
#define __ODROID_TOUCH_H__
...
//[*]--------------------------------------------------------------------------------------------------[*]
//
// ODROID Control Function define
//
//[*]--------------------------------------------------------------------------------------------------[*]
extern	int 			odroid_calibration	(struct touch *ts);
extern	int 			odroid_i2c_read	    (struct i2c_client *client, unsigned char *cmd, unsigned int cmd_len, unsigned char *data, unsigned int len);
extern	void			odroid_work		    (struct touch *ts);
extern	void			odroid_enable		(struct touch *ts);
extern	void			odroid_disable		(struct touch *ts);
extern	int				odroid_early_probe	(struct touch *ts);
extern	int				odroid_probe		(struct touch *ts);

//[*]--------------------------------------------------------------------------------------------------[*]
#endif /* __ODROID_TOUCH_H__ */
//[*]--------------------------------------------------------------------------------------------------[*]
//[*]--------------------------------------------------------------------------------------------------[*]
